...
if has('unix')
    nnoremap <a-F7> :wa<cr>:!cd ~/git/pyqt-kobzone && source venv/bin/activate && python DCScripts/DCCompileRCC.py && python main.py<cr>
    inoremap <a-F7> <ESC>:wa<cr>:!cd ~/git/pyqt-kobzone && source venv/bin/activate && python DCScripts/DCCompileRCC.py && python main.py<cr>
endif
