...
Item{
    ...
    property bool pressed: tphKnopkaPovorotPo.pressed//true - нажали false - не нажали
    //property bool pressed: maKnopkaPovorotPo.pressed//true - нажали false - не нажали
    ...
    */
    Item {
        ...
        Rectangle {
            ...
            color: {
                if(root.enabled)//Если активирована кнопка, то...
                    tphKnopkaPovorotPo.pressed ? Qt.darker(clrKnopki, root.maxDarker) : clrKnopki
                    //maKnopkaPovorotPo.containsMouse ? Qt.darker(clrKnopki, root.maxDarker) : clrKnopki
