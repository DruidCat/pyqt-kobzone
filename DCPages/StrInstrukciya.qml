...
при той же скорости.</li>
<li><b>paraphrase-multilingual (384D, многоязычная)</b> — поддерживает более 50 языков, включая русский. \
Рекомендуется для многоязычных документов.</li>
<li><b>all-mpnet-base-v2 (768D, максимальное качество)</b> — обеспечивает наилучшее качество поиска \
среди моделей с 768D. Требует больше памяти и работает медленнее.</li>
...
<li><b>e5-small-v2 (384D, альтернатива)</b> — современная модель от Microsoft с хорошим балансом \
скорости и качества поиска.</li>
<li><b>e5-large-v2 (1024D, максимум для GPU)</b> — самая точная модель с максимальной размерностью \
векторов. Требует мощной видеокарты с объёмом памяти от 8 ГБ. Рекомендуется только для GPU-режима.</li>
</ul>
<p><b>Рекомендация:</b> для большинства задач оптимальна модель <b>paraphrase-multilingual</b> \
(хорошее качество + поддержка русского языка). Для слабых компьютеров — <b>all-MiniLM-L6-v2</b>. \
Для максимальной точности на мощном ПК — <b>e5-large-v2</b> или <b>all-mpnet-base-v2</b>.</p>
</ol>
<p><b>ФУНКЦИОНАЛ:</b></p>
<ol>
<p><img src = \"qrc:/resources/images/DCButtons/24x24/DCKnopkaNazad.png\"> - Вернуться в предыдущее меню \
